...
BUILTIN_SLASH_COMMANDS: list[BuiltinSlashCommand] = [
    ...
    BuiltinSlashCommand("compact", "Compact context; optional next-phase direction: /compact <direction>"),
    BuiltinSlashCommand("subagents", "Read-only tasks: list | spawn <task> | review <task> | show <id> | cancel <id>"),
    ...
    BuiltinSlashCommand("plan", "Enter Plan Mode or show current Plan actions"),
